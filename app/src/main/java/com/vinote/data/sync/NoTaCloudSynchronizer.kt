...
class NoTaCloudSynchronizer(
    ...
    private suspend fun pushTransactions(userId: String): Int {
        ...
        for (transaction in transactions) {
            ...
            clientTable("transactions").upsert<JsonObject>(
                payload,
    ...
    private suspend fun pushWallets(userId: String): Int {
        ...
        for (wallet in wallets) {
            ...
            clientTable("wallet_accounts").upsert<JsonObject>(payload, onConflict = "id")
        }
        return wallets.size
    }
    ...
    private suspend fun pushBudget(userId: String): Int {
        ...
        clientTable("budgets").upsert<JsonObject>(payload, onConflict = "id")
        return 1
    }
    ...
    private suspend fun pushGoals(userId: String): Int {
        ...
        for (goal in goals) {
            ...
            clientTable("savings_cloud").upsert<JsonObject>(
                payload,
